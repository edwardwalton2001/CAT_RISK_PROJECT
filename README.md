...
- **Concentration Relative to Policy Limit:** POL00072 had the highest zone TIV-to-limit ratio at 6.4x, indicating that the TIV concentrated within         a single hazard zone was substantially higher than the policy limit. However, the zone TIV was approximately $6.4 million and was associated         with a Low hazard band. This highlights that a high exposure-to-limit ratio does not necessarily indicate high hazard severity and should be         considered alongside the underlying hazard characteristics.
- **State-Hazard Zone Concentration:** * **State-Hazard Zone Concentration:** New Jersey had the highest total state exposure, with approximately           $273.7 million in TIV. However, Texas showed the greatest concentration within a single hazard zone, with its largest hazard zone accounting         for approximately 17% of the state's total TIV.
