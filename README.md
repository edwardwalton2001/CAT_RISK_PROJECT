...
- **Policy–Hazard Zone Concentration:** Policy POL00275 had the largest qualifying hazard-zone exposure, with $8,580,608 of TIV concentrated in            hazard zone. This represents 33% of the policy's total TIV and 3.4x its policy limit.
- **Concentration Relative to Policy Limit:** POL00072 had the highest zone TIV-to-limit ratio at 6.4x, highlighting a substantial concentration of         insured value within a single hazard zone relative to the policy limit.
